...
save_name = "spectral_T21_nd3_baseESN_job2"  # Name of file to save results to

model_params = (
  approx_res_size = 100000,   # size of the reservoir; NOTE: Must be larger than all of input params.
