module BaseESN
  ...
  include("train_ridge.jl")
  using .TrainRidge: train_default, train_closedform, train_mlj, train_optim
  include("train_hybrid.jl")
  using .TrainHybrid: train_closedform_hybrid, train_mlj_hybrid, train_optim_hybrid, HyESNpredict
  ...
  function predict_hybrid(esn, predict_len, W_out; ϵᵦ=0.05)
    output = HyESNpredict(esn, predict_len, W_out)
  end
end
