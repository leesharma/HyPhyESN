...
save_name = "CFSR_2year.hdf5"



def download_data(main_url, params, months, years, save_dir):
...
def process_data(months, years, save_dir, dataset_directory, save_name):
...
if __name__ == '__main__':
    process_data(months, years, save_dir, dataset_directory, save_name)
